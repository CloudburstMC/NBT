...
public class NBTIO {
    ...
    public static CompoundTag read(InputStream inputStream, ByteOrder endianness, boolean com.nukkitx.network) throws IOException {
        try (NBTInputStream stream = new NBTInputStream(inputStream, endianness, com.nukkitx.network)) {
    ...
    public static CompoundTag read(byte[] data, ByteOrder endianness, boolean com.nukkitx.network) throws IOException {
        return read(new ByteArrayInputStream(data), endianness, com.nukkitx.network);
    }
    ...
    public static byte[] write(CompoundTag tag, ByteOrder endianness, boolean com.nukkitx.network) throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        try (NBTOutputStream stream = new NBTOutputStream(baos, endianness, com.nukkitx.network)) {
    ...
    public static byte[] write(Collection<CompoundTag> tags, ByteOrder endianness, boolean com.nukkitx.network) throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        try (NBTOutputStream stream = new NBTOutputStream(baos, endianness, com.nukkitx.network)) {
    ...
    public static void write(CompoundTag tag, OutputStream outputStream, ByteOrder endianness, boolean com.nukkitx.network) throws IOException {
        try (NBTOutputStream stream = new NBTOutputStream(outputStream, endianness, com.nukkitx.network)) {
            Tag.writeNamedTag(tag, stream);
        }
    }
